...
function BasicForms() {
    ...
    useEffect(() => {
        fetch(process.env.REACT_APP_API_URL + '/header-nav/parent-items?token=' + JSON.parse(localStorage.getItem("token")))
    ...
    const ParentSelect = () => (
        <CFormGroup row>
            ...
            <CCol xs="12" md="9">
                <CSelect custom name="parent_id" id="select" onChange={event => setParentId(event.target.value)}>
                    {Object.entries(headerNavs).map((t, k) => <option key={k} value={t[0]}>{t[1]}</option>)}
                </CSelect>
            </CCol>
        </CFormGroup>
    )
            ...
            <CRow>
                <CCol xs="12" md="6">
                    <CCard>
                        ...
                        <CCardBody>
                            <CForm className="form-horizontal">
                                ...
                                <CFormGroup row>
                                    ...
                                    <CCol xs="12" md="9">
                                        <CInput id="link_url" name="link_url" placeholder="Enter Link Url"
                        ...
                        <CCardFooter>
                            <CButton type="submit" size="sm" color="primary" onClick={submitHandler}><CIcon
